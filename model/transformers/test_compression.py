...
def test_encoder_decoder_compression(config_path: Path):
    ...
    from spatial_transformer import ScalePreservingSpatialTransformer
...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        print('Usage: python test_compression.py <config.yaml>')
        print('Example: python test_compression.py training/training_configs/spatial_transformer.yaml')
        sys.exit(2)
